  ...
  return (
    ...
    >
      ...
      <circle
        ...
        cy="38"
        r="16"
        fill="oklch(0.95 0.05 155)"
        stroke="oklch(0.8 0.1 155)"
        strokeWidth="1.5"
      />
      <line
        x1="22"
        ...
        x2="22"
        y2="44"
        stroke="oklch(0.5 0.15 155)"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <polyline
        points="16,36 22,30 28,36"
        stroke="oklch(0.5 0.15 155)"
        strokeWidth="2"
        strokeLinecap="round"
...
export function PermissionsIllustration() {
  return (
    ...
    >
      ...
      {/* shield body */}
      <path
        d="M60 10 L96 26 L96 58 Q96 84 60 100 Q24 84 24 58 L24 26 Z"
        fill="var(--surface-2)"
        stroke="var(--border-strong)"
        strokeWidth="1.5"
      />
      {/* shield inner fill */}
      <path
        d="M60 18 L88 31 L88 58 Q88 78 60 92 Q32 78 32 58 L32 31 Z"
        fill="var(--brand)"
        opacity="0.07"
      />
      {/* lock body */}
      ...
      {/* lock shackle */}
      <path
        d="M53 52 L53 46 Q53 38 60 38 Q67 38 67 46 L67 52"
        stroke="var(--brand)"
        strokeWidth="2.5"
        strokeLinecap="round"
        fill="none"
...
export function ReportsIllustration() {
  return (
    ...
    >
      ...
      {/* trend line */}
      <polyline
        points="35,70 49,58 63,62 77,48"
        stroke="var(--brand)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
