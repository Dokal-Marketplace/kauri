            ...
            <>
              ...
              >
                ...
                <Field label="Numéro d'agrément">
                  <input className="input" defaultValue="MFI-BF-2024-0142" />
                </Field>
                <Field label="Devise">
                  <select
                    className="input"
              ...
              <SetCard
                title="Agences"
                sub="3 agences actives · ajoutez ou archivez selon votre couverture."
              >
          ...
          {section === 'tpe' && (
            <>
              ...
              >
                ...
                />
                <Field
                  label={`Durée maximale hors-ligne · ${offlineDays} jours`}
              ...
              >
                <Field label="Dépôt maximum">
                  <div className="input-row">
                    <input className="input" defaultValue="500 000" />
                    <span className="cell-sub">FCFA</span>
                  </div>
                </Field>
                <Field label="Retrait maximum">
                  <div className="input-row">
                    <input className="input" defaultValue="200 000" />
                    <span className="cell-sub">FCFA</span>
                  </div>
                </Field>
                <Field label="Cotisation tontine">
                  <div className="input-row">
                    <input className="input" defaultValue="50 000" />
                    <span className="cell-sub">FCFA</span>
                  </div>
                </Field>
              </SetCard>
              ...
              >
                <div className="upload">
                  ...
                  <button className="btn brand sm" style={{ marginLeft: 'auto' }}>
                    Déployer
                  </button>
                </div>
              </SetCard>
          ...
          {section === 'securite' && (
            <>
              ...
              >
                ...
                />
                <Field
                  label={`Verrouillage automatique · ${autoLock} min`}
                ...
                <div className="plan-row">
                  <div>
                    ...
                    <div className="cell-sub">
                      Jusqu'à 5 TPE · 200 clients par agent · sync illimitée
                    </div>
                  </div>
            ...
            <SetCard title="Intégrations" sub="Connectez Kauri à vos outils existants.">
              {[
                ...
                },
                {
                  ...
                  s: 'Connecté',
                  dot: 'actif',
                  d: 'Confirmations client par SMS',
                },
                {
                  n: 'Comptabilité Sage',
                  s: 'Non connecté',
                ...
                <div key={it.n} className="upload">
                  ...
                  <button className="btn sm">
                    {it.dot === 'actif' ? 'Configurer' : 'Connecter'}
                  </button>
                </div>
              ))}
            </SetCard>
