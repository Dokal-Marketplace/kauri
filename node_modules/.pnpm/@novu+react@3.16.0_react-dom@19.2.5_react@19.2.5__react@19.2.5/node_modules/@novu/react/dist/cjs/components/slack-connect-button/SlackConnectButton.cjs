...
var SlackConnectButton_exports = {};
__export(SlackConnectButton_exports, {
  SlackConnectButton: () => SlackConnectButton
});
module.exports = __toCommonJS(SlackConnectButton_exports);
...
//# sourceMappingURL=SlackConnectButton.cjs.map