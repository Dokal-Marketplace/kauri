...
export default defineSchema({
    ...
    effectivePermissions: defineTable({
        ...
        policyResult: v.optional(v.union(v.literal("allow"), v.literal("deny"), v.literal("deferred"))),
    ...
    auditLog: defineTable({
        tenantId: v.optional(v.string()),
        timestamp: v.number(),
        action: v.union(v.literal("permission_check"), v.literal("role_assigned"), v.literal("role_revoked"), v.literal("permission_granted"), v.literal("permission_denied"), v.literal("attribute_set"), v.literal("attribute_removed"), v.literal("relation_added"), v.literal("relation_removed"), v.literal("policy_evaluated")),
        userId: v.string(),
