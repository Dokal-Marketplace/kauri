    ...
    handler: async (ctx) => {
        try {
            ...
            if (existingExpired === null) {
                await crons.register(ctx, { kind: "interval", ms: INTERVAL_MS }, api.mutations.runScheduledCleanup, {}, CRON_NAME_EXPIRED);
            }
            const existingAudit = await crons.get(ctx, {
                name: CRON_NAME_AUDIT_RETENTION,
            });
            if (existingAudit === null) {
                await crons.register(ctx, { kind: "interval", ms: INTERVAL_MS }, api.mutations.runAuditRetentionCleanup, {}, CRON_NAME_AUDIT_RETENTION);
            }
        }
        catch (err) {
...
//# sourceMappingURL=cronSetup.js.map