    ...
    handler: async (ctx, args) => {
        ...
        const validAssignments = assignments.filter((a) => {
            if (isExpired(a.expiresAt))
                return false;
            if (args.scope && !matchesScope(a.scope, args.scope))
                return false;
            return true;
        });
...
const auditLogActionValidator = v.union(v.literal("permission_check"), v.literal("role_assigned"), v.literal("role_revoked"), v.literal("permission_granted"), v.literal("permission_denied"), v.literal("attribute_set"), v.literal("attribute_removed"), v.literal("relation_added"), v.literal("relation_removed"), v.literal("policy_evaluated"));
...
export const getAuditLog = query({
    ...
    returns: v.union(v.array(auditEntryShape), v.object({
    ...
    handler: async (ctx, args) => {
        ...
        if (args.userId !== undefined) {
            ...
            dbQuery = ctx.db
                .query("auditLog")
                .withIndex("by_tenant_action", (q) => q
                .eq("tenantId", args.tenantId)
