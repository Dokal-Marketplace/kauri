...
function createInfiniteScroll(fetcher, options) {
  ...
  const reset = () => chunk7B52C2XE_js.__async(null, null, function* () {
    setData([]);
...
var CountProvider = (props) => {
  ...
  const updateTabCounts = () => chunk7B52C2XE_js.__async(null, null, function* () {
    if (tabs().length === 0) {
      return;
    }
  ...
  useWebSocketEvent({
    ...
    eventHandler: (_0) => chunk7B52C2XE_js.__async(null, [_0], function* ({
      result: notification
    }) {
      var _a, _b;
...
var useChannelConnection = (options) => {
  ...
  const [connection, { mutate, refetch }] = solidJs.createResource(options, (_0) => chunk7B52C2XE_js.__async(null, [_0], function* ({ connectionIdentifier }) {
    var _a;
    try {
...
var _tmpl$3 = /* @__PURE__ */ web.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round class=size-4><path d="M5 12l5 5l10 -10">`);
var _tmpl$22 = /* @__PURE__ */ web.template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round class=size-4><path d="M5 12l14 0">`);
var Checkbox = (props) => {
...
var _tmpl$6 = /* @__PURE__ */ web.template(`<svg xmlns=http://www.w3.org/2000/svg fill=none viewBox="0 0 20 20"><path fill=currentColor d="M5.833 8.333L10 12.5l4.166-4.167H5.833z">`);
...
var _tmpl$7 = /* @__PURE__ */ web.template(`<svg viewBox="0 0 20 20"fill=none xmlns=http://www.w3.org/2000/svg><path d="M9.20425 9.99907L12.9168 13.7116L11.8563 14.7721L7.08325 9.99907L11.8563 5.22607L12.9168 6.28657L9.20425 9.99907Z"fill=currentColor>`);
var ArrowLeft = (props) => {
  return (() => {
    var _el$ = _tmpl$7();
    web.spread(_el$, props, true, true);
...
var _tmpl$8 = /* @__PURE__ */ web.template(`<svg viewBox="0 0 20 20"fill=none xmlns=http://www.w3.org/2000/svg><path d="M10.7957 10.0009L7.08325 6.2884L8.14375 5.2279L12.9168 10.0009L8.14375 14.7739L7.08325 13.7134L10.7957 10.0009Z"fill=currentColor>`);
...
var _tmpl$12 = /* @__PURE__ */ web.template(`<svg viewBox="0 0 8 6"fill=none xmlns=http://www.w3.org/2000/svg><path d="M2.99994 4.58847L7.33298 0L8 0.705765L2.99994 6L0 2.82356L0.666549 2.11779L2.99994 4.58847Z"fill=currentColor>`);
var Check = (props) => {
  return (() => {
    var _el$ = _tmpl$12();
    web.spread(_el$, props, true, true);
...
var _tmpl$13 = /* @__PURE__ */ web.template(`<svg viewBox="0 0 16 16"fill=none xmlns=http://www.w3.org/2000/svg><circle cx=8 cy=8 r=6 fill=#1FC16B></circle><path d="M5.5 8L7.25 9.75L10.5 6.5"stroke=white stroke-width=1.25 stroke-linecap=round stroke-linejoin=round>`);
...
var _tmpl$210 = /* @__PURE__ */ web.template(`<span><div>`);
...
var _tmpl$33 = /* @__PURE__ */ web.template(`<svg width=6 height=6 viewBox="0 0 6 6"fill=none xmlns=http://www.w3.org/2000/svg><path d="M5.00175 1.70402L0.705765 6L0 5.29424L4.29548 0.998253H0.509608V0H6V5.49039H5.00175V1.70402Z"fill=currentColor>`);
...
var _tmpl$34 = /* @__PURE__ */ web.template(`<span class="nt-z-10 nt-text-xs nt-text-stripes">`);
var _tmpl$211 = /* @__PURE__ */ web.template(`<span class="nt-z-10 nt-text-xs">\u2022`);
var _tmpl$35 = /* @__PURE__ */ web.template(`<a target=_blank class="nt-z-10 nt-flex nt-items-center nt-gap-1 nt-justify-center"><span class=nt-text-xs></span><span class=nt-text-xs>Novu`);
...
var useArchiveAll = (props) => {
  const novuAccessor = useNovu();
  const archiveAll = (..._0) => chunk7B52C2XE_js.__async(null, [..._0], function* ({
    tags,
    data
  } = {}) {
    var _a, _b;
...
var useArchiveAllRead = (props) => {
  const novuAccessor = useNovu();
  const archiveAllRead = (..._0) => chunk7B52C2XE_js.__async(null, [..._0], function* ({
    tags,
    data
  } = {}) {
    var _a, _b;
...
var useNotificationsInfiniteScroll = (props) => {
  ...
  const [data, { initialLoading, setEl, end, mutate, reset }] = createInfiniteScroll(
    (after) => chunk7B52C2XE_js.__async(null, null, function* () {
      var _a, _b;
  ...
  const refetch = (_0) => chunk7B52C2XE_js.__async(null, [_0], function* ({ filter: filter2 }) {
...
var usePreferences = (options) => {
  ...
  const [preferences, { mutate, refetch }] = solidJs.createResource(
    ...
    (_0) => chunk7B52C2XE_js.__async(null, [_0], function* ({ tags, severity, criticality }) {
      try {
...
var useReadAll = (props) => {
  const novuAccessor = useNovu();
  const readAll = (..._0) => chunk7B52C2XE_js.__async(null, [..._0], function* ({
    tags,
    data
  } = {}) {
    var _a, _b;
...
var ChannelRow = (props) => {
  const style = useStyle();
  const updatePreference = (enabled) => chunk7B52C2XE_js.__async(null, null, function* () {
    props.onChange({
      [props.channel.channel]: enabled
    });
  });
  const onChange = (checked) => chunk7B52C2XE_js.__async(null, null, function* () {
...
var _tmpl$57 = /* @__PURE__ */ web.template(`<span data-localization=preferences.schedule.dayScheduleCopy.title>`);
var _tmpl$216 = /* @__PURE__ */ web.template(`<span data-localization=preferences.schedule.dayScheduleCopy.selectAll>`);
var _tmpl$311 = /* @__PURE__ */ web.template(`<div>`);
...
var _tmpl$59 = /* @__PURE__ */ web.template(`<button aria-label=Schedule tabindex=0>`);
var _tmpl$218 = /* @__PURE__ */ web.template(`<div class=nt-max-w-56>`);
var _tmpl$312 = /* @__PURE__ */ web.template(`<div><span data-localization=preferences.schedule.title>`);
...
var _tmpl$63 = /* @__PURE__ */ web.template(`<div>`);
...
var _tmpl$60 = /* @__PURE__ */ web.template(`<div>`);
var Preferences = () => {
  var _a, _b, _c;
  const novuAccessor = useNovu();
  const style = useStyle();
  ...
  const updatePreference = (preference) => (channels) => chunk7B52C2XE_js.__async(null, null, function* () {
    yield preference == null ? void 0 : preference.update({
      channels
    });
  });
  const bulkUpdatePreferences = (preferences2) => (channels) => chunk7B52C2XE_js.__async(null, null, function* () {
  ...
  return web.createComponent(solidJs.Show, {
    ...
    get children() {
      return web.createComponent(web.Portal, {
        ...
        get children() {
          return web.createComponent(Root2, {
            get children() {
...
var _tmpl$64 = /* @__PURE__ */ web.template(`<button>`);
...
var _tmpl$65 = /* @__PURE__ */ web.template(`<button type=button>`);
...
var _tmpl$219 = /* @__PURE__ */ web.template(`<div><span>`);
...
var _tmpl$68 = /* @__PURE__ */ web.template(`<div role=tabpanel>`);
...
var _tmpl$69 = /* @__PURE__ */ web.template(`<div role=tablist>`);
var _tmpl$220 = /* @__PURE__ */ web.template(`<div class="nt-relative nt-z-[-1]">`);
...
var _tmpl$70 = /* @__PURE__ */ web.template(`<input>`);
...
var _tmpl$71 = /* @__PURE__ */ web.template(`<span class=nt-text-sm>`);
var _tmpl$221 = /* @__PURE__ */ web.template(`<span><span>`);
var _tmpl$313 = /* @__PURE__ */ web.template(`<span>`);
...
var _tmpl$74 = /* @__PURE__ */ web.template(`<span>`);
var _tmpl$222 = /* @__PURE__ */ web.template(`<div>`);
var _tmpl$314 = /* @__PURE__ */ web.template(`<code>context`);
var _tmpl$412 = /* @__PURE__ */ web.template(`<code>ConnectChat`);
var _tmpl$511 = /* @__PURE__ */ web.template(`<code>NovuProvider`);
var _tmpl$610 = /* @__PURE__ */ web.template(`<code>connectionMode="shared"`);
var ConnectChat = (props) => {
  ...
  const buttonContent = () => (() => {
    ...
    web.insert(_el$, web.createComponent(Motion.span, {
      ...
      get children() {
        var _el$2 = _tmpl$74();
        web.insert(_el$2, () => isConnected() ? "Disconnect" : "Connect");
        web.effect(() => web.className(_el$2, style({
...
var _tmpl$75 = /* @__PURE__ */ web.template(`<div><div data-localization=preferences.title>`);
...
var _tmpl$76 = /* @__PURE__ */ web.template(`<strong>`);
var _tmpl$223 = /* @__PURE__ */ web.template(`<em>`);
var _tmpl$315 = /* @__PURE__ */ web.template(`<p>`);
var Bold = (props) => {
  const style = useStyle();
  return (() => {
    var _el$ = _tmpl$76();
...
var Markdown = (props) => {
  ...
  const style = useStyle();
  const tokens = solidJs.createMemo(() => chunkWDGG3OER_js.parseMarkdownIntoTokens(local.children));
  return (() => {
    var _el$3 = _tmpl$315();
...
var _tmpl$78 = /* @__PURE__ */ web.template(`<div><span>:</span><select><option value=AM>AM</option><option value=PM>PM`);
...
var _tmpl$79 = /* @__PURE__ */ web.template(`<div><div><p></p></div><div>`);
...
var _tmpl$80 = /* @__PURE__ */ web.template(`<div><span>`);
var _tmpl$224 = /* @__PURE__ */ web.template(`<span>`);
var SNOOZE_PRESETS = [{
    ...
    get children() {
      return [web.createComponent(Tooltip.Trigger, {
        asChild: (childProps) => web.createComponent(Button, web.mergeProps({
          ...
          onClick: (e) => chunk7B52C2XE_js.__async(null, null, function* () {
            e.stopPropagation();
                    ...
                    return [web.createComponent(SnoozeDropdownItem, {
                      ...
                      get children() {
                        return web.createComponent(SnoozeDateTimePicker, {
                          ...
                          onSelect: (date) => chunk7B52C2XE_js.__async(null, null, function* () {
...
var _tmpl$225 = /* @__PURE__ */ web.template(`<a><div></div><div><div></div><div></div></div><div class="nt-w-1.5 nt-flex nt-justify-center nt-shrink-0">`);
var _tmpl$316 = /* @__PURE__ */ web.template(`<img>`);
var _tmpl$413 = /* @__PURE__ */ web.template(`<div>`);
...
var DefaultNotification = (props) => {
  ...
  const handleNotificationClick = (e) => chunk7B52C2XE_js.__async(null, null, function* () {
    var _a, _b, _c;
    e.stopPropagation();
    e.preventDefault();
  ...
  const handleActionButtonClick = (action, e) => chunk7B52C2XE_js.__async(null, null, function* () {
...
var _tmpl$84 = /* @__PURE__ */ web.template(`<div>`);
var _tmpl$226 = /* @__PURE__ */ web.template(`<p data-localization=notifications.emptyNotice>`);
var _tmpl$317 = /* @__PURE__ */ web.template(`<div><p>Trigger your notification. No setup needed.</p><p>Temporary &lt;Inbox />, data will expire in 24h. Connect API key to persists messages, enable
...
var _tmpl$85 = /* @__PURE__ */ web.template(`<div>`);
...
var NotificationList = (props) => {
  ...
  const handleOnNewMessagesClick = (e) => chunk7B52C2XE_js.__async(null, null, function* () {
    e.stopPropagation();
...
var _tmpl$86 = /* @__PURE__ */ web.template(`<span>`);
...
var _tmpl$87 = /* @__PURE__ */ web.template(`<div>`);
...
var SubscriptionPreferenceGroupRow = (props) => {
  ...
  const handleGroupChange = (checked) => chunk7B52C2XE_js.__async(null, null, function* () {
  ...
  const handlePreferenceChange = (preference) => (checked) => chunk7B52C2XE_js.__async(null, null, function* () {
...
var SubscriptionPreferenceRow = (props) => {
  ...
  const handleChange = (checked) => chunk7B52C2XE_js.__async(null, null, function* () {
    yield preference().update({
      value: checked
    });
  });
...
var SubscriptionButtonWrapper = (props) => {
  ...
  const onSubscribeClick = () => chunk7B52C2XE_js.__async(null, null, function* () {
  ...
  Notifications: (props) => {
    if (props.renderNotification) {
      const _a = props, {
        ...
        renderCustomActions
      } = _a, otherProps = chunk7B52C2XE_js.__objRest(_a, [
        "renderBody",
        "renderSubject",
        "renderAvatar",
        "renderDefaultActions",
    ...
    const _b = props, {
      renderNotification
    } = _b, propsWithoutRenderNotification = chunk7B52C2XE_js.__objRest(_b, [
      "renderNotification"
    ]);
...
var Renderer = (props) => {
  const inboxComponents = solidJs.createMemo(() => [...props.nodes.entries()].filter(([_, node]) => !SUBSCRIPTION_COMPONENTS.includes(node.name) && !CHANNEL_COMPONENTS.includes(node.name)).map(([element, _]) => element));
  ...
  const channelComponents = solidJs.createMemo(() => [...props.nodes.entries()].filter(([_, node]) => CHANNEL_COMPONENTS.includes(node.name)).map(([element, _]) => element));
  solidJs.onMount(() => {
    var _a;
                ...
                get children() {
                  return web.createComponent(InboxProvider, {
                    ...
                    get children() {
                      ...
                      }), web.createComponent(SimpleComponentsRenderer, {
                        get elements() {
