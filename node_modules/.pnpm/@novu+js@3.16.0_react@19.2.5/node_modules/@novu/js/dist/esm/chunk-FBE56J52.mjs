...
var PartySocketClient = class extends BaseModule {
  constructor({
    ...
    __privateSet(this, _socketOptions, socketOptions);
  }
...
var Socket = class extends BaseModule {
  constructor({
    ...
    __privateAdd(this, _socketOptions2);
    ...
    __privateSet(this, _socketOptions2, socketOptions);
  }
  onSessionSuccess({ token }) {
...
initializeSocket_fn2 = function() {
  return __async(this, null, function* () {
    ...
    __privateSet(this, _socketIo, io(__privateGet(this, _socketUrl2), __spreadValues({
      reconnectionDelayMax: 1e4,
      transports: ["websocket"],
      query: {
        token: `${__privateGet(this, _token2)}`
      }
    }, (_a = __privateGet(this, _socketOptions2)) != null ? _a : {})));
    ...
    (_b = __privateGet(this, _socketIo)) == null ? void 0 : _b.on("notification_received" /* RECEIVED */, __privateGet(this, _notificationReceived2));
    (_c = __privateGet(this, _socketIo)) == null ? void 0 : _c.on("unseen_count_changed" /* UNSEEN */, __privateGet(this, _unseenCountChanged2));
    (_d = __privateGet(this, _socketIo)) == null ? void 0 : _d.on("unread_count_changed" /* UNREAD */, __privateGet(this, _unreadCountChanged2));
  });
};
